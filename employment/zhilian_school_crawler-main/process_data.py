...
# 定义常量
JOB_CLASS_MAP_PATH = 'job_class_map.json'
NEW_JOB_CLASS_MAP_PATH = "./crawler/job_class_map_new.json"
JOB_FOLDER_PATH = "./crawler/data"
...
if __name__ == '__main__':
    # renumber_error_id(JOB_FOLDER_PATH)
    # print(extract_empty_file_map(JOB_FOLDER_PATH))
